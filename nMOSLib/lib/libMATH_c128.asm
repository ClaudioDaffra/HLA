...
.endc
	...
	; Define BASIC ROM routine addresses

	basicROM_fdivt 				= $AF27		; FAC1 = FAC2 / FAC1
	basicROM_int 				= $AF2D		; FAC1 = INT(FAC1)
	basicROM_fmultt 			= $AF21		; FAC1 = FAC1 * FAC2
	basicROM_fsubt 				= $AF15		; FAC1 = FAC2 - FAC1
	...
	mod_f40	.proc
		...
		jsr basic.store_fac2_in_fac1     ; Temporarily copy FAC2 to FAC1
		lda #<bufferFac2
		ldy #>bufferFac2
		jsr basic.store_fac1     ; Store (now B in FAC1) to bufferFac2
