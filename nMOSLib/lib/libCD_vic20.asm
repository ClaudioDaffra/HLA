...
.weak
	...
	SCREEN						= 	SCREEN_ADDRESS_VIC20
	COLOR						= 	COLOR_ADDRESS_VIC20
	SCREEN_WIDTH				=	SCREEN_WIDTH_VIC20
	SCREEN_HEIGHT				=	SCREEN_HEIGHT_VIC20
	SCREEN_SIZE					=	SCREEN_SIZE_VIC20
	BITMAP						= 	BITMAP_ADDRESS_VIC20
	
	BASIC_START					=   BASIC_START_VIC20
	BASIC_STOP					=   BASIC_STOP_VIC20

	MEM_BOTTOM					=	MEM_BOTTOM_VIC20
	MEM_TOP						=	MEM_TOP_VIC20
	MEM_EXTRA_BOTTOM			=	MEM_EXTRA_BOTTOM_VIC20
	MEM_EXTRA_TOP				=	MEM_EXTRA_TOP_VIC20

	PROGRAM_STACK_SIZE    		=	STACK_SIZE_SHORT		;    $ff
	PROGRAM_STACK_ADDRESS     	=	MEM_EXTRA_TOP			;	7679	;	$1DFF

	CHARACTER					=	CHARACTER_ADDRESS_VIC20
	
	BUFFER_ADDRESS				=	BUFFER_ADDRESS_VIC20
	BUFFER_SIZE					=	BUFFER_SIZE_VIC20
